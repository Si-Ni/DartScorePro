    ...
    <div className="hero is-justify-content-center is-align-items-center is-fullheight">
      <div className="hero-body">
        <div className="content">
          <link rel="icon" type="image/png" href="/PrivacyPolicy_icon.png" />
          ...
          <h4>Speicherung Ihrer Daten</h4>
          <p>
            Beim erstmaligen Registrieren erklären Sie sich damit einverstanden, dass wir Ihre E-Mail-Adresse, Ihren
            Nutzernamen und den Hash Ihres Passworts speichern. Für diese Datenspeicherung nutzen wir den Anbieter
            MongoDB. Diese Informationen werden benötigt, um eine reibungslose Funktion der Website sicherzustellen und
            beispielsweise Ihre Spielstatistiken personalisiert zu speichern und für Sie abrufbar zu machen.
          </p>
          <h2>2. Hosting</h2>
          ...
          <p>E-Mail: s5002080@ba-sachsen.de</p>
          <p>
          ...
          <p>
            Wir nutzen Cookies, um mittels eines Tokens zu ermöglichen, dass Sie sich nicht bei jedem Besuch der Seite
            erneut anmelden müssen. Dadurch bleiben Sie für eine bestimmte Zeitdauer angemeldet. Das manuelle Abmelden
            bewirkt die Löschung dieses Tokens.
          </p>
          <p>
